...
This guide describes how to integrate with Open's Connected Banking Enterprise APIs for beneficiary management (AXIS RIB only), fund transfers, banking statements, account balance, and bank account listings.